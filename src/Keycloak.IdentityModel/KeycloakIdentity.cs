...
namespace Keycloak.IdentityModel
{
    ...
    {
        private static JwtSecurityToken _accessToken;
        private static JwtSecurityToken _idToken;
        private static JwtSecurityToken _refreshToken;
        ...
        public static async Task<Uri> GenerateLogoutUriAsync(IKeycloakParameters parameters, Uri baseUri, string redirectUrl = null)
        {
            ...
            var logoutParams = uriManager.BuildEndSessionEndpointContent(baseUri, _idToken.RawData, redirectUrl);
        ...
        protected async Task CopyFromJwt(string accessToken, string refreshToken = null, string idToken = null)
        {
            ...
            _kcClaims = GenerateJwtClaims(accessSecurityToken as JwtSecurityToken, idSecurityToken as JwtSecurityToken, refreshSecurityToken as JwtSecurityToken);
